    ...
    stage "Container Prep"
        ...
        mycontainer.inside("-u jenkins -v /var/run/docker.sock:/var/run/docker.sock:rw") {
            ...
            stage "Build Rest Java API image - Package"
                ...
                def rest_api_image = docker.build("elastest/edm:0.9.0","./rest-java")
